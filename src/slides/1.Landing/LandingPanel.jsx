...
function LandingPanel() {
  return (
    <section className="full-height text-white video-wrapper   panel-inner">
      ...
      <div className="slide-content full-height flex flex-col content-end justify-end">
        <div className="flex flex-col">
          <div className="md:text-2xl lg:text-3xl mb-32">
          ...
          <div className="flex flex-row content-center gap-1 mb-4">
            <img
              src={DownArrow}
              alt="arrow-down"
              className="icon-white icon scale-125"
            />
