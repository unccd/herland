const textH2 =
  'max-sm:text-4xl sm:text-4xl md:text-4xl lg:text-4xl xl:text-5xl 2xl:text-5xl font-light';
...
const landingHeaderDescription =
  'md:text-2xl 2xl:text-3xl lg:text-1xl sm:text-xl mb-32 landing-text-hidden';
